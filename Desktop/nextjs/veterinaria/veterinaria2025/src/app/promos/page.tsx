// /app/promos/page.tsx
'use client'; // Necesario para usar useSearchParams y otros hooks de React
...
// Importa la interfaz y la función de fetching real
...
import Nav from '../components/header'; // Asumo que estos componentes existen
import Footer from '../components/footer'; // Asumo que estos componentes existen
import { FaArrowLeft } from 'react-icons/fa6';
import PromoSection from '../components/promoSection'; // Asumo que este componente existe
    ...
    useEffect(() => {
        const fetchPromoData = async () => {
            ...
            if (promoId) {
                ...
                setPromo(null); // No hay promoId en la URL
            }
            setLoading(false);
        };

        fetchPromoData();
    }, [promoId]); // Se re-ejecuta si el promoId cambia en la URL
        ...
        <div className="flex bg-gray-200 flex-col min-h-screen">
            ...
            <main className="flex-grow container mx-auto p-8 max-w-4xl bg-white shadow-lg rounded-lg my-10">
                ...
                <div className="flex items-center justify-between border-t pt-4">
                    <div className="flex flex-col items-start"> {/* Flex container for prices */}
