...
import { Mascota, Servicio, Cita, CitaServicio, addMascotaToCita } from './actions'; // Importar Servicio de actions.ts
...
export default function ManageAppointmentModal({ isOpen, onClose, cita, onServicesUpdated }: ManageAppointmentModalProps) {
  ...
  const handleAddMascota = async () => {
    ...
    if (!newMascotaName || !newMascotaTipo ) {
    ...
    const newMascotaData: Omit<Mascota, 'id' | 'servicios'> = {
      ...
      tipo: newMascotaTipo,
      sexo: newMascotaSexo? newMascotaSexo : '', // Por defecto si no se selecciona
      edad: newMascotaEdad? newMascotaEdad : '', // Por defecto si no se selecciona
      info_adicional: newMascotaInfoAdicional? newMascotaInfoAdicional : '', // Por defecto si no se selecciona
      observacion: newMascotaObservacion? newMascotaObservacion : '', // Por defecto si no se selecciona
    };
